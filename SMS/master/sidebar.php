		...
		<ul class="nav-list">
				...
				<div class="main-link">
					...
					<ul class="sub-menu blank">
						<li><a href="<?php
										...
										?>" class="link-name">Dashboard</a></li>
					</ul>
				</div>
			</li>
			<li class="<?php echo ($current_page == 'student_attendance.php') ? 'selected' : ''; ?>">
				<div class="main-link">
					...
					<ul class="sub-menu blank">
						<li><a href="/SMS/student_attendance.php" class="link-name ">Attendance</a></li>
					</ul>
				</div>
			</li>
			...
			<?php if (hasAccess('student_details', $role)): ?>
				<li class="<?php echo ($current_page == 'create_student.php') ? 'selected' : ''; ?>">
					<div class="main-link">
						...
						<ul class="sub-menu blank">
							<li><a href="/SMS/master/database_upload/create_student.php" class="link-name">Student Details</a></li>
						</ul>
					</div>
				</li>
			<?php endif; ?>
			...
			<li class="<?php echo ($current_page == 'get_report.php') ? 'selected' : ''; ?>">
				<div class="main-link">
					...
					<ul class="sub-menu blank">
						<li><a href="/SMS/get_report.php" class="link-name">Report</a></li>
					</ul>
				</div>
			</li>
			...
			<?php if (!(in_array($role, [2, 3, 4]))): ?>
				<li class="<?php echo (
								$current_page == 'request_leave.php' ||
								$current_page == 'leave_approvals.php' ||
								$current_page == 'leave_status.php'

							) ? 'selected' : ''; ?>">
					<div class="my-icon-link">
						<a data-page="menu2">
							<i class="fi fi-rr-member-list"></i>
							<span class="link-name">Leave Info</span>
						</a>
						<i class="fi fi-rr-caret-down arrow"></i>
					</div>

					<ul class="sub-menu">
						<li><a class="link-name">Leave Info</a></li>

						<li><a href="/SMS/request_leave.php">Requests</a></li>
						<li><a href="/SMS/leave_approvals.php">Approvals</a></li>
						<li><a href="/SMS/leave_status.php">Status</a></li>
					</ul>
				</li>
			<?php endif; ?>
			...
			<?php if ($role == 1): ?>
				<li class="<?php echo ($current_page == 'achievements.php') ? 'selected' : ''; ?>">
					<div class="main-link">
						...
						<ul class="sub-menu blank">
							<li><a href="/SMS/achievements.php" class="link-name">Student Achievements</a></li>
						</ul>
					</div>
				</li>
			<?php endif; ?>
			...
			<?php if (!in_array($role, [0, 6, 7])): ?>
				<li class="<?php echo ($current_page == 'lms_portal_report.php') ? 'selected' : ''; ?>">
					<div class="main-link">
						<a href="/SMS/lms_portal_report.php">
							<i class="fi fi-rr-notes-medical"></i>
							<span class="link-name">LMS Report</span>
						</a>
						<ul class="sub-menu blank">
							<li><a href="/SMS/lms_portal_report.php" class="link-name">LMS Report</a></li>
						</ul>
					</div>
				</li>
			<?php endif; ?>
			...
			<li class="<?php echo ($current_page == 'devinfo.php') ? 'selected' : ''; ?>">
				<div class="main-link">
					...
					<ul class="sub-menu blank">
						<li><a href="/SMS/devinfo.php" class="link-name">Team</a></li>
					</ul>
				</div>
			</li>
