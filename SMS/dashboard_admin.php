...
include 'php/dashboard_admin_details.php';
?>
    ...
    <div class="container-fluid p-4">
        ...
        <div class="card mb-4 shadow-sm">
            <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                <h5 class="card-title mt-1">Edit - Requests</h5>
            </div>
            <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                    <div class="card-body text-center text-black bg-gradient-secondary rounded shadow-sm p-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="card border-0 rounded shadow h-100 bg-white">
