...
if(isset($_POST['reference_id'])){
	...
	}else if($action == "Accepted and Upward"){
		$update_query = 'update leave_record set status_id=5 where leave_id="'.$leave_id.'"';
	}else{
                $update_query = 'update leave_record set status_id=4 where leave_id="'.$leave_id.'"';
        }
