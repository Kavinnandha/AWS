...
$insert_details = 'insert into mapping_course_department_batch(course_id,mapping_id,batch_id,semester,section_id) values("'.$course_id.'","'.$mapping_id.'","'.$batch_id.'","'.$semester.'","'.$section_id.'")';
